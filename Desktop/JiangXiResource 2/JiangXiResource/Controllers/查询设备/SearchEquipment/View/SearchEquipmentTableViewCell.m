//
//  SearchEquipmentTableViewCell.m
//  JiangXiResource
//
...
@interface SearchEquipmentTableViewCell ()

@property(nonatomic , strong) UILabel *titleLabel;       // title

@end

@implementation SearchEquipmentTableViewCell
...
- (void)setModel:(SearchEquipmentListModel *)model{
